...
library(ggthemes) # Does not seem that ggthemes is actually used in the tutorial.
...
<!-- Hitting Run Document results in the creation of penguin_plot.png. Shouldn't we clean that up? DK: Please investigate. -->
...
```{r creating-your-first-ggplot-1, exercise = TRUE}

```

```{r creating-your-first-ggplot-1-hint-1, eval = FALSE}
library(...)
```

```{r creating-your-first-ggplot-1-test, include = FALSE}
library(tidyverse)
```
...
```{r creating-your-first-ggplot-2, exercise = TRUE}

```

```{r creating-your-first-ggplot-2-hint-1, eval = FALSE}
library(...)
```

```{r creating-your-first-ggplot-2-test, include = FALSE}
library(palmerpenguins)
```
...
```{r creating-your-first-ggplot-3}
question_text(NULL,
...
```{r creating-your-first-ggplot-4, exercise = TRUE}

```

```{r creating-your-first-ggplot-4-hint-1, eval = FALSE}
library(...)
```

```{r creating-your-first-ggplot-4-test, include = FALSE}
library(ggthemes)
```
...
```{r creating-your-first-ggplot-5, exercise = TRUE}

```

```{r creating-your-first-ggplot-5-hint-1, eval = FALSE}
penguins
```

```{r creating-your-first-ggplot-5-test, include = FALSE}
penguins
```
...
```{r creating-your-first-ggplot-6, exercise = TRUE}

```

```{r creating-your-first-ggplot-6-hint-1, eval = FALSE}
glimpse(...)
```

```{r creating-your-first-ggplot-6-test, include = FALSE}
glimpse(penguins)
```
...
```{r creating-your-first-ggplot-7, exercise = TRUE}

```

```{r creating-your-first-ggplot-7-hint-1, eval = FALSE}
ggplot(...)
```

```{r creating-your-first-ggplot-7-test, include = FALSE}
...
```{r creating-your-first-ggplot-8, exercise = TRUE}

```

```{r creating-your-first-ggplot-8-hint-1, eval = FALSE}
sqrt(...)
```

```{r creating-your-first-ggplot-8-test, include = FALSE}
sqrt(16)
```
...
```{r creating-your-first-ggplot-9, exercise = TRUE}

```

```{r creating-your-first-ggplot-9-hint-1, eval = FALSE}
16 |> ...
```

```{r creating-your-first-ggplot-9-test, include = FALSE}
16 |> sqrt()
```
...
```{r creating-your-first-ggplot-10, exercise = TRUE}

```

```{r creating-your-first-ggplot-10-hint-1, eval = FALSE}
penguins |> 
  ...
```

```{r creating-your-first-ggplot-10-test, include = FALSE}
penguins |>
  ggplot()
```
...
```{r creating-your-first-ggplot-11, exercise = TRUE}
...
```{r creating-your-first-ggplot-11-hint-1, eval = FALSE}
penguins |>
  ggplot(... = aes(x = ...))
```

```{r creating-your-first-ggplot-11-test, include = FALSE}
penguins |>
  ggplot(mapping = aes(x = flipper_length_mm))
```
...
```{r creating-your-first-ggplot-12, exercise = TRUE}
...
```{r creating-your-first-ggplot-12-hint-1, eval = FALSE}
penguins |>
  ggplot(mapping = aes(x = flipper_length_mm, 
                       y = ...))
```

```{r creating-your-first-ggplot-12-test, include = FALSE}
penguins |>
  ggplot(mapping = aes(x = flipper_length_mm, 
                       y = body_mass_g))
```
...
```{r creating-your-first-ggplot-13, exercise = TRUE}
...
```{r creating-your-first-ggplot-13-hint-1, eval = FALSE}
penguins |>
  ggplot(mapping = aes(x = flipper_length_mm, 
                       y = body_mass_g)) +
  ...
...
```{r creating-your-first-ggplot-13-test, include = FALSE}
penguins |>
  ggplot(mapping = aes(x = flipper_length_mm, 
                       y = body_mass_g)) +
    geom_point() 
...
```{r creating-your-first-ggplot-14, exercise = TRUE}
...
```{r creating-your-first-ggplot-14-hint-1, eval = FALSE}
penguins |>
  ... |> 
  ggplot(mapping = aes(x = flipper_length_mm, 
                       y = body_mass_g)) +
...
```{r creating-your-first-ggplot-14-test, include = FALSE}
penguins |>
  drop_na() |> 
  ggplot(mapping = aes(x = flipper_length_mm, 
                       y = body_mass_g)) +
...
```{r creating-your-first-ggplot-15, exercise = TRUE}
...
```{r creating-your-first-ggplot-15-hint-1, eval = FALSE}
penguins |>
  drop_na() |> 
  ggplot(mapping = aes(x = flipper_length_mm, 
                       y = body_mass_g, 
...
```{r creating-your-first-ggplot-15-test, include = FALSE}
penguins |>
  drop_na() |>
  ggplot(mapping = aes(x = flipper_length_mm, 
                       y = body_mass_g,
...
```{r creating-your-first-ggplot-16, exercise = TRUE}
...
```{r creating-your-first-ggplot-16-hint-1, eval = FALSE}
penguins |>
  drop_na() |>
  ggplot(mapping = aes(x = flipper_length_mm, 
                       y = body_mass_g, 
...
```{r creating-your-first-ggplot-16-test, include = FALSE}
penguins |>
  drop_na() |>
  ggplot(mapping = aes(x = flipper_length_mm, 
                       y = body_mass_g,
...
```{r creating-your-first-ggplot-17, exercise = TRUE}
...
```{r creating-your-first-ggplot-17-hint-1, eval = FALSE}
... +
  geom_smooth(method = "lm", ...) 
```

```{r creating-your-first-ggplot-17-test, include = FALSE}
penguins |>
  drop_na() |>
  ggplot(mapping = aes(x = flipper_length_mm, 
                       y = body_mass_g,
...
```{r creating-your-first-ggplot-18, exercise = TRUE}
...
```{r creating-your-first-ggplot-18-hint-1, eval = FALSE}
penguins |>
  drop_na() |>
  ggplot(mapping = aes(x = flipper_length_mm, 
                       y = body_mass_g)) +
...
```{r creating-your-first-ggplot-18-test, include = FALSE}
penguins |>
  drop_na() |>
  ggplot(mapping = aes(x = flipper_length_mm, 
                       y = body_mass_g)) +
...
```{r creating-your-first-ggplot-19, exercise = TRUE}
...
```{r creating-your-first-ggplot-19-hint-1, eval = FALSE}
penguins |>
  drop_na() |>
  ggplot(mapping = aes(x = flipper_length_mm, 
                       y = body_mass_g)) +
...
```{r creating-your-first-ggplot-19-test, include = FALSE}
penguins |>
  drop_na() |>
  ggplot(mapping = aes(x = flipper_length_mm, 
                       y = body_mass_g)) +
...
```{r creating-your-first-ggplot-20, exercise = TRUE}
...
```{r creating-your-first-ggplot-20-hint-1, eval = FALSE}
penguins |>
  drop_na() |>
  ggplot(mapping = aes(x = flipper_length_mm, 
                       y = body_mass_g)) +
...
```{r creating-your-first-ggplot-20-test, include = FALSE}
penguins |>
  drop_na() |>
  ggplot(mapping = aes(x = flipper_length_mm, 
                       y = body_mass_g)) +
...
```{r creating-your-first-ggplot-21, exercise = TRUE}
...
```{r creating-your-first-ggplot-21-hint-1, eval = FALSE}
penguins |>
  drop_na() |>
  ggplot(mapping = aes(x = flipper_length_mm, 
                       y = body_mass_g)) +
...
```{r creating-your-first-ggplot-21-test, include = FALSE}
penguins |>
  drop_na() |>
  ggplot(mapping = aes(x = flipper_length_mm, 
                       y = body_mass_g)) +
...
```{r creating-your-first-ggplot-22, exercise = TRUE}
...
```{r creating-your-first-ggplot-22-hint-1, eval = FALSE}
penguins |>
  drop_na() |>
  ggplot(mapping = aes(x = flipper_length_mm, 
                       y = body_mass_g)) +
...
```{r creating-your-first-ggplot-22-test, include = FALSE}
penguins |>
  drop_na() |>
  ggplot(mapping = aes(x = flipper_length_mm, 
                       y = body_mass_g)) +
...
```{r creating-your-first-ggplot-23, exercise = TRUE}
...
```{r creating-your-first-ggplot-23-hint-1, eval = FALSE}
penguins |>
  drop_na() |>
  ggplot(mapping = aes(x = flipper_length_mm, 
                       y = body_mass_g)) +
...
```{r creating-your-first-ggplot-23-test, include = FALSE}
penguins |>
  drop_na() |>
  ggplot(mapping = aes(x = flipper_length_mm, 
                       y = body_mass_g)) +
...
<!-- MP: This plot uses `drop_na()`, but the exercises leading up to the student making the plot don't. DK: You're right. Add an exercise which uses drop_na(). But when?  -->
...
<!-- DK: Misplaced; should be placed *after* the first use of `facet_wrap()`.  -->
...
<!-- DK: Also misplaced. Needs to be further down.  -->
...
<!-- DK: Is this misplaced? Not entirely sure.  -->
...
<!-- DK: This is too much prose in the question section.  -->
