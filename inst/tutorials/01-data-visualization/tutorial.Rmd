...
<!-- DK: Add test chunks. -->
<!-- PC: Test chunks are not needed for many of them due to much of this tutorial being focused on creating pre-made graphs -->
...
```{r creating-first-ggplot-ex-1, exercise = TRUE}
...
```{r creating-first-ggplot-ex-3, exercise = TRUE}

```

```{r creating-first-ggplot-3-hint-1, eval = FALSE}
library(...)
```
...
```{r creating-first-ggplot-ex-4, exercise = TRUE}
...
```{r creating-first-ggplot-ex-5, exercise = TRUE}
...
```{r creating-first-ggplot-ex-6, exercise = TRUE}
...
```{r creating-first-ggplot-ex-7, exercise = TRUE}
...
```{r creating-first-ggplot-ex-8, exercise = TRUE}
...
```{r creating-first-ggplot-ex-9, exercise = TRUE}
...
```{r creating-first-ggplot-ex-10, exercise = TRUE}
...
```{r creating-first-ggplot-ex-11, exercise = TRUE}
...
penguins |>
  ggplot(mapping = aes(x = flipper_length_mm, y = ...))
```
...
```{r creating-first-ggplot-ex-12, exercise = TRUE}
...
```{r creating-first-ggplot-ex-13, exercise = TRUE}
...
```{r creating-first-ggplot-ex-14, exercise = TRUE}
...
```{r creating-first-ggplot-ex-15, exercise = TRUE}
...
`
```{r creating-first-ggplot-ex-16, exercise = TRUE}
...
```{r creating-first-ggplot-ex-17, exercise = TRUE}
...
```{r creating-first-ggplot-ex-18, exercise = TRUE}
...
```{r creating-first-ggplot-ex-19, exercise = TRUE}
...
```{r creating-first-ggplot-ex-20, exercise = TRUE}
...
```{r geom-point-ex-1, exercise = TRUE}
...
```{r geom-point-ex-2, exercise = TRUE}
...
```{r geom-point-ex-3, exercise = TRUE}
...
```{r geom-point-ex-4, exercise = TRUE}
...
```{r geom-point-ex-5, exercise = TRUE}
...
```{r geom-point-ex-6, exercise = TRUE}
...
```{r geom-point-ex-7, exercise = TRUE}
...
```{r geom-point-ex-8, exercise = TRUE}
...
`
```{r geom-point-ex-9, exercise = TRUE}
...
```{r geom-point-ex-10, exercise = TRUE}
...
```{r geom-histogram-ex-1, exercise = TRUE}
...
```{r geom-histogram-ex-2, exercise = TRUE}
...
```{r geom-histogram-ex-3, exercise = TRUE}
...
```{r geom-histogram-ex-4, exercise = TRUE}
...
```{r geom-histogram-ex-5, exercise = TRUE}
...
```{r geom-histogram-ex-6, exercise = TRUE}
...
```{r geom-histogram-ex-7, exercise = TRUE}
...
```{r geom-density-ex-1, exercise = TRUE}
...
```{r geom-density-ex-2, exercise = TRUE}
...
```{r geom-density-ex-3, exercise = TRUE}
...
```{r geom-density-ex-4, exercise = TRUE}
...
```{r geom-density-ex-5, exercise = TRUE}
...
```{r geom-density-ex-6, exercise = TRUE}
...
```{r geom-density-ex-7, exercise = TRUE}
...
```{r geom-density-ex-8, exercise = TRUE}
...
```{r geom-boxplot-ex-1, exercise = TRUE}
...
Run `penguins` and pipe it to a `ggplot()` call.
```{r geom-boxplot-ex-2, exercise = TRUE}
...
```{r geom-boxplot-ex-3, exercise = TRUE}
...
```{r geom-boxplot-ex-4, exercise = TRUE}
...
```{r geom-boxplot-ex-5, exercise = TRUE}
...
```{r geom-boxplot-ex-6, exercise = TRUE}
...
```{r facet-wrap-ex-1, exercise = TRUE}
...
```{r facet-wrap-ex-2, exercise = TRUE}
...
```{r facet-wrap-ex-3, exercise = TRUE}
...
```{r facet-wrap-ex-4, exercise = TRUE}
...
```{r facet-wrap-ex-5, exercise = TRUE}
...
```{r facet-wrap-ex-6, exercise = TRUE}
...
```{r facet-wrap-ex-7, exercise = TRUE}
...
```{r facet-wrap-ex-8, exercise = TRUE}
...
```{r facet-wrap-ex-9, exercise = TRUE}
...
```{r saving-plots-ex-1, exercise = TRUE}
...
```{r saving-plots-ex-2, exercise = TRUE}
...
```{r saving-plots-ex-3, exercise = TRUE}
...
```{r saving-plots-ex-4, exercise = TRUE}
...
```{r saving-plots-ex-5, exercise = TRUE}
