...
Insert `drop_na()` in the middle of the pipe, after `penguins` but before the call to `ggplot()`.
...
`geom_smooth()` creates a fitted line or curve which can help identify trends and patterns in data. It offers different smoothing methods like linear or polynomial regression and loess smoothing.
