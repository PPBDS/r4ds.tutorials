...
<!-- DK: Every question should have either a test code chunk or a chunk which runs the correct code and shows the student the results, so that she can see the correct results. There are a lot of little things to clean up. -->
...
<!-- DK: Add more questions? Something about going to data frames with as.data.frame? Differences between tibbles and data frames? How about as_tibble()? Maybe matrices? -->
