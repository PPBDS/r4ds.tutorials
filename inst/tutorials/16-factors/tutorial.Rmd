...
<!-- Make sure exercises have test cases. -->
<!-- Make sure test chunks have a code chunk name. -->
<!-- Add knowledge drops where there are none.  -->
...
```{r factor-basics-10-test, include = FALSE}
