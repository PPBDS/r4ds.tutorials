...
<!-- DK: Add knowledge drops where there are none.  -->
...
fct_lump_n() is particularly useful when you have a factor with many levels, but you're only interested in analyzing the most common ones. Without it, analysis's can become cluttered and difficult to interpret.
