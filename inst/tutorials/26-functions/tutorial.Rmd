...
```{r simple-function-2-hint, eval = FALSE}
myfunc_1 <- function(){
...
```{r simple-function-3-hint, eval = FALSE}
myfunc_1()
```
...
```{r simple-function-4-hint, eval = FALSE}
myfunc_1
```
...
```{r simple-function-5-hint, eval = FALSE}
myfunc_2 <- ...(x){
...
```{r simple-function-6-hint, eval = FALSE}
myfunc_2(...)
```
...
```{r simple-function-7-hint, eval = FALSE}
myfunc_2()
```
...
```{r simple-function-8-hint, eval = FALSE}
myfunc_3 <- function(x){
  ...
}
```
...
```{r simple-function-9-hint, eval = FALSE}
myfunc_3(..)
```
...
```{r simple-function-10-hint, eval = FALSE}
myfunc_3("abc")
```
...
```{r simple-function-11-hint, eval = FALSE}
myfunc_3()
```
