...
<!-- DK: Just the four or so most important functions. DONE (so far) -->
...
<!-- DK: Stuff like this goes in Introduction. DONE -->
...
<!-- DK: What will I learn? This section will cover . . . DONE -->
...
<!-- DK: Must load in the Console. DONE -->
...
<!-- DK: You need some guided poking. Pipe flights to select() ... Probably just one question. DONE

flights |> 
	select(year:dep_delay)
-->

Next, prompt the AI to generate R code that takes `flights` and breaks scheduled and actual departure times into hours and minutes using %/% and %%. If you have not done so before, provide a tibble of **flights** for the AI to use. If necessary, change the code so that the result of the pipe is not assigned to a variable. Add the code to your QMD in a new chunk. Save the file. Place your cursor on the first line of the code and run `Cmd/Ctrl + Enter`.
