...
In your QMD, create a new code cell and use `library()` to load the **nycflights13** package. Place your cursor on that line and run `Cmd/Ctrl + Enter`.

From the Console, CP/CR.
