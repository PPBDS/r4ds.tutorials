...
<!-- DK: Just one QMD. DONE -->

<!-- DK: At end, use `quarto publish gh-pages analysis.qmd`. Last question, before summary, is for the URL for their published QMD. DONE -->

<!-- DK: Publish it in the Summary. DONE -->
