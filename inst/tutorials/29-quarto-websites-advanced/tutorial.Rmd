...
In the Source pane, open the `_quarto.yml` file. Replace `title: "."` with `title: "Website 1"`. Save the file. The indentation before `title` should be the same extent as before `navbar` below it.
...
Open the `index.qmd` file in the Source pane. Replace `title: "."` with `title: "Website 1"`. Save the file.
...
Note that the `title` (`"Website 1"`) in `_quarto.yml` has no necessary connection to the `title` (`"Website 1"`) in `index.qmd`. The former is the title for the entire website. The latter is the title for just the (yet-to-be-created) `index.html` page.

### Exercise 8

Add `*Rproj` to the `.gitignore` file and click Save. 
