...
<!-- DK: Knowledge drop the two links from the summary. - DONE -->

<!-- DK: This tutorial is long! Maybe don't include the practice section? Or maybe it is just long to write! - DONE -->

<!-- DK: FIX - Maybe one of the nice looking babynames plots could go at the end of this tutorial. Or maybe we make a new one? -->
<!-- SD: Maybe we shouldn't make a plot for this tutorial as it took the students 78 mins on avg, so we shouldn't add an extra section just to make a model. -->
...
<!-- DK: Note how the `n` column in `babynames` makes this code harder than we would like. Maybe break this up into three steps? - DONE -->
...
<!-- DK: Should this be `x` or `string` in this paragraph? - DONE -->
...
<!-- SD: Although I do feel that it would be beneficial, I don't think that the benefits of extending this question would outweigh the toll that it has on the time that the student spends on it - frankly, I think that it's better to save the students' some time. -->
...
<!-- SD: I disagree, back when I did this tutorial I was relieved that everything was laid out in front of me and that I didn't have to do any hard work. With the rise of AI, most of these Regular Expressions would be forgotten anyways so I feel that it's best not to waste students' time by making them write code. -->
...
<!-- DK: FIX - need to start with a simple example which explains using a vector of parameters. - DONE -->
...
<!-- SD: Old Vestigial Sections that were Previously Removed due to Length Concerns -->
<!-- ## Pattern control -->
<!-- ###  -->
