...
<!-- DK: Finish missing sections below. - DONE -->
...
<!-- DK: Note the typo in the original in R4DS. Have someone look into this and submit a PR. -->
...
<!-- SD: The following 3 sections are trying to be concise so it doesn't take up too much of the students' time. They involve just blatantly running code blocks to save time. -->
...
<!-- SD: There was also a section in R4DS that used the `comments = TRUE` argument but I thought it would be too confusing and obscure for the students, so I left it out. -->
...
<!-- SD: Here, the book also talks about `pivot_longer()`'s `names_pattern` argument and the `delim` argument in `separate_[longer/wider]_delim()`, but both of those seem to obscure and too hard/long to explain to be worthy of being in this section. -->
