...
<!-- DK: This tutorial is long! Maybe don't include the practice section? Or maybe it is just long to write! -->
<!-- SD: The average for this one was 33 minutes and the most it took any student was 78 minutes. I wouldnt consider that very long, especially considering that the other tutorial assigned for that day took roughly the same amount of time. -->
