...
Copy the previous code, modify the argument for `left_join()` to `weather |> select(origin,time_hour, temp, wind_speed)` which just select the origin, time, temperature and wind speed from `weather` data set.
