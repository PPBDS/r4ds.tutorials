...
<!-- See below for DK Windows comments -->
...
<!-- MP: The above paragraph seems a little wordy to me. But that's probably jsut me, though. -->
...
<!-- MP: Maybe a bit more about projects? Switching between them, exiting, difference between being in a project and not, etc. -->
...
<!-- MP: Why are we saving the document just to name it before we even put anything in it? This sounds like a very, very bad practice to me -- instead save *after* you've put at least something in! -->
...
<!-- MP: Hold on; these next 2 exercises aren't supposed to be here. They're supposed to be in the previous section! Where in that section, though? -->
...
<!-- MP: Added a big info block about comments. Mostly based off of Python's PEP 8 style guide. -->
...
<!-- MP: Why were we giving away answers here? Don't we want people to type code? -->
