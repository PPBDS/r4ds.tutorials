...
<!-- DK: Change this so that we only create a new project. This process magically moves us from project-1 to project-3. -->
...
<!-- DK: Exercises without instructions are bad exercises. -->
