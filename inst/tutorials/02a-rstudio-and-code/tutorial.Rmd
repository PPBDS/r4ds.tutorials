...
<!-- Median time on the tutorial was two hours. Too long! Split into two parts: perhaps rstudio-and-scripts and rstudio-and-quarto (the second assumes the completion of the first). -->
