...
```{r datetime-components--1-hint, eval = FALSE}
glimpse(...)
```
...
```{r datetime-components--2-hint, eval = FALSE}
flights_dt |> 
...
```{r datetime-components--3-hint, eval = FALSE}
... |> 
 ... |> 
  ggplot(aes(x = ...))
```
...
```{r datetime-components--4-hint, eval = FALSE}
... |> 
  ... |> 
  ... +
  geom_bar()
