...
<!-- No instructions given, maybe just add the last sentence of previous knowledge drop here -->
...
<!-- MH: Hint didn't work so I changed month == 2 to day = 1 to match previous exercises -->
...
<!-- MH: The Exercise above filters for January 1st and 2nd, and the hint doesn't match the exercise above either -->
...
<!-- MH: Not all flights are on Jan. 1, once you get to 18, there is January 1st, 2nd, 3rd, and on 19, there are dates in October-->
