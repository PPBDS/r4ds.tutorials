...
```{r saving-plots-7, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r saving-plots-7-hint-1, eval = FALSE}
by_clarity |> 
  mutate(
...
```{r saving-plots-8, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r saving-plots-8-hint-1, eval = FALSE}
...
```{r saving-plots-9, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r saving-plots-9-hint-1, eval = FALSE}
walk2(
  by_clarity$path,
  by_clarity$plot)
```
...
```{r saving-plots-10, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r saving-plots-10-hint-1, eval = FALSE}
walk2(
  by_clarity$path,
  by_clarity$plot,
  \(path, plot) ggsave())
...
```{r saving-plots-11, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r saving-plots-11-hint-1, eval = FALSE}
walk2(
  by_clarity$path,
  by_clarity$plot,
