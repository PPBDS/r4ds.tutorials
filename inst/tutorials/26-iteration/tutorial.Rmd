...
This tutorial covers [Chapter 26: Iteration](https://r4ds.hadley.nz/iteration.html) from [*R for Data Science (2e)*](https://r4ds.hadley.nz/) by Hadley Wickham, Mine Çetinkaya-Rundel, and Garrett Grolemund.
...
```{r modifying-multiple-columns-10, exercise = TRUE}
df2 <- tibble(
  grp = sample(2, 10, replace = TRUE),
  a = rnorm(10),
  b = rnorm(10),
...
```{r modifying-multiple-columns-11, exercise = TRUE}

```

```{r modifying-multiple-columns-11-hint-1, eval = FALSE}
df2 |> 
  summarise()
```
...
```{r modifying-multiple-columns-12, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r modifying-multiple-columns-12-hint-1, eval = FALSE}
df2 |> 
  summarise (.by = grp)
```
...
```{r modifying-multiple-columns-13, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r modifying-multiple-columns-13-hint-1, eval = FALSE}
... |> 
  summarise (.by = ...,
             across(everything(), ...))
```
...
```{r modifying-multiple-columns-14, exercise = TRUE}
df_miss <- tibble(
  a = rnorm_na(5, 1),
  b = rnorm_na(5, 1),
  c = rnorm_na(5, 2),
...
```{r modifying-multiple-columns-15, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r modifying-multiple-columns-15-hint-1, eval = FALSE}
df_miss |> 
  summarize ()
```
...
```{r modifying-multiple-columns-16, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r modifying-multiple-columns-16-hint-1, eval = FALSE}
df_miss |> 
  summarize (across(..., ...), 
             n = n())
```
...
```{r modifying-multiple-columns-17, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r modifying-multiple-columns-17-hint-1, eval = FALSE}
df_miss |> 
  summarize()
```
...
```{r modifying-multiple-columns-18, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r modifying-multiple-columns-18-hint-1, eval = FALSE}
df_miss |> 
  summarise(across(),
            n = n())
```
...
```{r modifying-multiple-columns-19, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r modifying-multiple-columns-19-hint-1, eval = FALSE}
... |> 
  summarise(...(a:d, 
...
```{r modifying-multiple-columns-20, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r modifying-multiple-columns-20-hint-1, eval = FALSE}
df_miss |> 
  ...
...
```{r modifying-multiple-columns-21, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r modifying-multiple-columns-21-hint-1, eval = FALSE}
df_miss |> 
  ...(across(),
            n = n())
```
...
```{r modifying-multiple-columns-22, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r modifying-multiple-columns-22-hint-1, eval = FALSE}
df_miss |> 
  summarise(...(a:d, ...),
            n = n())
```
...
```{r modifying-multiple-columns-23, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r modifying-multiple-columns-23-hint-1, eval = FALSE}
df_miss |> 
...
```{r modifying-multiple-columns-24, exercise = TRUE}
df_miss |> 
  summarize( across (a:d, 
                     list (median = \(x) median(x, na.rm = TRUE),
                           n_miss = \(x) sum(is.na(x)))),
...
```{r modifying-multiple-columns-25, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r modifying-multiple-columns-25-hint-1, eval = FALSE}
df_miss |> 
  summarize(... (a:d, 
                    list (...,
                          n_miss = ...elt()),
...
```{r reading-multiple-files-21, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r reading-multiple-files-21-hint-1, eval = FALSE}
write_csv()
```
...
```{r reading-multiple-files-22, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r reading-multiple-files-22-hint-1, eval = FALSE}
...
```{r reading-multiple-files-23, exercise = TRUE}
df <- read_csv(path)
```
...
```{r reading-multiple-files-24, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r reading-multiple-files-24-hint-1, eval = FALSE}
df |> 
    filter(!is.na(id))
```
...
```{r reading-multiple-files-25, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r reading-multiple-files-25-hint-1, eval = FALSE}
  df |> 
    filter(!is.na(id)) |> 
    mutate(...)
```
...
```{r reading-multiple-files-26, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r reading-multiple-files-26-hint-1, eval = FALSE}
  df |> 
    filter(!is.na(id)) |> 
    mutate(id = tolower(id)) |> 
    pivot_longer(...)
...
```{r reading-multiple-files-27, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r reading-multiple-files-27-hint-1, eval = FALSE}
process_file <- function(path) {
  df <- read_csv(path)
...
```{r reading-multiple-files-28, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r reading-multiple-files-28-hint-1, eval = FALSE}
paths |> 
  map()
```
...
```{r reading-multiple-files-29, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r reading-multiple-files-29-hint-1, eval = FALSE}
paths |> 
  map(process_file)
```
...
```{r reading-multiple-files-30, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r reading-multiple-files-30-hint-1, eval = FALSE}
paths |> 
  map(process_file) |> 
  list_rbind()
```
...
```{r reading-multiple-files-31, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r reading-multiple-files-31-hint-1, eval = FALSE}
paths |> 
  map(readxl::read_excel)
```
...
```{r reading-multiple-files-32, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r reading-multiple-files-32-hint-1, eval = FALSE}
tibble()
```
...
```{r reading-multiple-files-33, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r reading-multiple-files-33-hint-1, eval = FALSE}
tibble(
    col_name = names(df))
```
...
```{r reading-multiple-files-34, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r reading-multiple-files-34-hint-1, eval = FALSE}
tibble(
    col_name = names(df), 
    col_type = map_chr(df, vctrs::vec_ptype_full))
```
...
```{r reading-multiple-files-35, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r reading-multiple-files-35-hint-1, eval = FALSE}
tibble(
    col_name = names(df), 
    col_type = map_chr(df, vctrs::vec_ptype_full),
    n_miss = map_int(df, \(x) sum(is.na(x))))
...
```{r reading-multiple-files-36, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r reading-multiple-files-36-hint-1, eval = FALSE}
function(df) {
  tibble(
    col_name = names(df), 
    col_type = map_chr(df, vctrs::vec_ptype_full),
...
```{r reading-multiple-files-37, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r reading-multiple-files-37-hint-1, eval = FALSE}
... <- function(df) {
  tibble(
    col_name = names(df), 
    col_type = map_chr(df, vctrs::vec_ptype_full),
...
```{r reading-multiple-files-38, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r reading-multiple-files-38-hint-1, eval = FALSE}
df_types(gapminder)
```
...
```{r reading-multiple-files-39, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r reading-multiple-files-39-hint-1, eval = FALSE}
paths |> 
  map()
```
...
```{r reading-multiple-files-40, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r reading-multiple-files-40-hint-1, eval = FALSE}
paths |> 
  map(possibly())
```
...
```{r reading-multiple-files-41, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r reading-multiple-files-41-hint-1, eval = FALSE}
paths |> 
...
```{r reading-multiple-files-42, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r reading-multiple-files-42-hint-1, eval = FALSE}
... <- paths |> 
  map(possibly(\(path) readxl::read_excel(path), NULL))
```
...
```{r reading-multiple-files-43, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r reading-multiple-files-43-hint-1, eval = FALSE}
files |> list_rbind()
```
...
```{r reading-multiple-files-44, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r reading-multiple-files-44-hint-1, eval = FALSE}
...
```{r reading-multiple-files-45, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r reading-multiple-files-45-hint-1, eval = FALSE}
...
```{r reading-multiple-files-46, exercise = TRUE}
paths[failed]
```
...
```{r saving-multiple-outputs-4-hint-1, eval = FALSE}
con |> tbl("gapminder")
```
...
```{r saving-multiple-outputs-6-hint-1, eval = FALSE}
function(path) {
...
```{r saving-multiple-outputs-11, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r saving-multiple-outputs-11-hint-1, eval = FALSE}
con |> 
  tbl("gapminder")
```
...
```{r saving-multiple-outputs-12, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r saving-multiple-outputs-12-hint-1, eval = FALSE}
con |> 
  ... |> 
  count(year)
```
...
```{r saving-multiple-outputs-13, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r saving-multiple-outputs-13-hint-1, eval = FALSE}
group_nest()
```
...
```{r saving-multiple-outputs-14, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r saving-multiple-outputs-14-hint-1, eval = FALSE}
group_nest(clarity)
```
...
```{r saving-multiple-outputs-15, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r saving-multiple-outputs-15-hint-1, eval = FALSE}
diamonds |> 
  ...(clarity)
```
...
```{r saving-multiple-outputs-16, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r saving-multiple-outputs-16-hint-1, eval = FALSE}
by_clarity <- ... |> 
  group_nest(...)
```
...
```{r saving-multiple-outputs-17, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r saving-multiple-outputs-17-hint-1, eval = FALSE}
by_clarity
```
...
```{r saving-multiple-outputs-18, exercise = TRUE}
by_clarity$data[[1]]
```
...
```{r saving-multiple-outputs-19, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r saving-multiple-outputs-19-hint-1, eval = FALSE}
by_clarity |> 
  mutate()
```
...
```{r saving-multiple-outputs-20, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r saving-multiple-outputs-20-hint-1, eval = FALSE}
by_clarity |> 
...
```{r saving-multiple-outputs-21, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r saving-multiple-outputs-21-hint-1, eval = FALSE}
walk2()
```
...
```{r saving-multiple-outputs-22, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r saving-multiple-outputs-22-hint-1, eval = FALSE}
...
```{r saving-multiple-outputs-23, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r saving-multiple-outputs-23-hint-1, eval = FALSE}
function(df) {}
```
...
```{r saving-multiple-outputs-24, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r saving-multiple-outputs-24-hint-1, eval = FALSE}
function(df) {
  ggplot()}
```
...
```{r saving-multiple-outputs-25, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r saving-multiple-outputs-25-hint-1, eval = FALSE}
function(...) {
...
```{r saving-multiple-outputs-26, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r saving-multiple-outputs-26-hint-1, eval = FALSE}
function(df) {
...
```{r saving-multiple-outputs-27, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r saving-multiple-outputs-27-hint-1, eval = FALSE}
function(df) {
  ggplot(df, aes(x = carat)) + geom_histogram(binwidth = 0.1)}
```
...
```{r saving-multiple-outputs-28, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r saving-multiple-outputs-28-hint-1, eval = FALSE}
carat_histogram <- function(df) {
  ggplot(...) + geom_histogram(...)}
```
...
```{r saving-multiple-outputs-29, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r saving-multiple-outputs-29-hint-1, eval = FALSE}
by_clarity |> 
  mutate(
...
```{r saving-multiple-outputs-30, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r saving-multiple-outputs-30-hint-1, eval = FALSE}
...
```{r saving-multiple-outputs-31, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r saving-multiple-outputs-31-hint-1, eval = FALSE}
walk2(
  by_clarity$path,
  by_clarity$plot)
```
...
```{r saving-multiple-outputs-32, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r saving-multiple-outputs-32-hint-1, eval = FALSE}
walk2(
  by_clarity$path,
  by_clarity$plot,
  \(path, plot) ggsave())
...
```{r saving-multiple-outputs-33, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r saving-multiple-outputs-33-hint-1, eval = FALSE}
walk2(
  by_clarity$path,
  by_clarity$plot,
...
This tutorial covered [Chapter 26: Iteration](https://r4ds.hadley.nz/iteration.html) from [*R for Data Science (2e)*](https://r4ds.hadley.nz/) by Hadley Wickham, Mine Çetinkaya-Rundel, and Garrett Grolemund.
