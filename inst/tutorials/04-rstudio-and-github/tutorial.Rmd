...
<!-- Each project begins with repo/project. Then does base QMD/html. Then edit .gitignore and commit/push. If we had fourth project, these 6 steps might just be the first question! Always finish by publishing something and making a final commit/push. -->
