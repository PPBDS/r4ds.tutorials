...
Restart your R session with `Session -> Restart R`. (This is not the same thing as restarting RStudio.) You could also use `Command/Ctrl + Shift + 0` to restart R. Using the shortcut key is always a good idea.
