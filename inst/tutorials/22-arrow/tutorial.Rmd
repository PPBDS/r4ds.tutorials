...
# We can also write out, and then work with, parquet files.
...
<!-- Using CheckoutYear and CheckoutMonth is a little concerning for our test cases since we have no ensured/checked that the test data includes rows for every year/month combination. But (presumably!) all the code works regardless . . . -->
