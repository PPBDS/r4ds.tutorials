...
# DK: Arrg! This is currently working locally, but failing on CRAN. Why? Some
# weirdness in open_dataset()? Something about not being able to do stuff in the
# data directory? Try this?

file.copy("data/test.csv", csv_path)
