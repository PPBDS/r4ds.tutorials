...
<!-- LD: Need to look up how to test an error. -->
...
<!-- LD: Should this be a test case? -->
```{r last-letter-of-boy-names-3-hint-2, eval = FALSE}
babynames |>
  filter(sex == 'M')
