...
<!-- DK: Revisit the questions above and below to make them more like R4DS. Done-->
...
<!-- DK: Make second hints into tests, assuming that they work. Done-->
...
<!-- AB: not working for somereason with colour and problem happened through whole tutorial  -->
...
<!-- DK: Remove hints that are too thorough. They can often become tests. Done-->

```{r last-letter-of-boy-names-11-test, include = FALSE}
babynames |>
  filter( 
    sex == 'M') |>
  select(
