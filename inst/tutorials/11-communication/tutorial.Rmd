...
<!-- More Annotations exercise 3 getting nothing, did it how I would think it is supposed to be done ex 4 on now its working -->

<!-- More Annotations exercise 20/21 "alighn" -->

<!-- Legend Layout not sure what point of "base" is for first few but nothing will plot with it there -->
...
<!-- Layout, creating a new variable just doesn't work, Similar to issues I had earlier, seems like in all of these tutorials setting a variable like so -->

<!-- new <- old |> -->
<!--    something() -->

<!-- doesn't work for me. Also later on I can not reference <new> after I create it in an earlier step. -->
...
Within `geom_text()`, add the `vjust` argument and set it equal to `"bottom"`. 
...
<!-- DK: The rest of this Annotate section still needs cleaning. -->
...
```{r annotations-21-test, include = FALSE}
...
```{r annotations-22-test, include = FALSE}
...
In this section, we will learn about how to display plots more appropriately by using scales. The most common use of the **scales** package is to customise to control the appearance of axis and legend labels. Use a `break_` function to control how breaks are generated from the limits, and a `label_` function to control how breaks are turned in to labels.
...
```{r scales-15-test, include = FALSE}
...
```{r scales-16-test, include = FALSE}
...
```{r scales-17-test, include = FALSE}
...
```{r scales-18-test, include = FALSE}
...
```{r scales-19-test, include = FALSE}
...
```{r scales-20-test, include = FALSE}
...
```{r scales-21-test, include = FALSE}
...
```{r scales-22-test, include = FALSE}
...
```{r scales-23-test, include = FALSE}
...
```{r scales-24-test, include = FALSE}
...
```{r legend-layout-5-test, include = FALSE}
...
```{r legend-layout-6-test, include = FALSE}
...
```{r replacing-a-scale-17-test, include = FALSE}
...
```{r replacing-a-scale-18-test, include = FALSE}
...
```{r replacing-a-scale-19-test, include = FALSE}
...
```{r replacing-a-scale-20-test, include = FALSE}
...
```{r replacing-a-scale-21-test, include = FALSE}
...
```{r replacing-a-scale-22-test, include = FALSE}
...
```{r zooming-5-test, include = FALSE}
...
```{r zooming-6-test, include = FALSE}
...
```{r zooming-7-test, include = FALSE}
...
```{r zooming-8-test, include = FALSE}
...
```{r zooming-9-test, include = FALSE}
...
```{r zooming-10-test, include = FALSE}
...
```{r zooming-11-test, include = FALSE}
...
```{r zooming-12-test, include = FALSE}
...
```{r zooming-13-test, include = FALSE}
...
```{r zooming-14-test, include = FALSE}
...
```{r zooming-15-test, include = FALSE}
...
```{r zooming-16-test, include = FALSE}
...
```{r zooming-17-test, include = FALSE}
...
```{r zooming-18-test, include = FALSE}
...
```{r zooming-19-test, include = FALSE}
...
```{r zooming-20-test, include = FALSE}
...
```{r zooming-21-test, include = FALSE}
...
```{r zooming-22-test, include = FALSE}
...
```{r more-zooming-1-test, include = FALSE}
...
```{r more-zooming-2-test, include = FALSE}
...
```{r more-zooming-3-test, include = FALSE}
...
```{r more-zooming-4-test, include = FALSE}
...
```{r more-zooming-5-test, include = FALSE}
...
```{r more-zooming-6-test, include = FALSE}
...
```{r more-zooming-7-test, include = FALSE}
...
```{r more-zooming-8-test, include = FALSE}
...
```{r more-zooming-9-test, include = FALSE}
...
```{r more-zooming-10-test, include = FALSE}
...
```{r more-zooming-11-test, include = FALSE}
...
```{r more-zooming-12-test, include = FALSE}
...
```{r more-zooming-13-test, include = FALSE}
...
```{r more-zooming-14-test, include = FALSE}
...
```{r more-zooming-15-test, include = FALSE}
...
```{r more-zooming-16-test, include = FALSE}
...
```{r more-zooming-17-test, include = FALSE}
...
```{r more-zooming-18-test, include = FALSE}
...
```{r more-zooming-19-test, include = FALSE}
...
```{r more-zooming-20-test, include = FALSE}
...
```{r more-zooming-21-test, include = FALSE}
...
```{r more-zooming-22-test, include = FALSE}
...
```{r more-zooming-23-test, include = FALSE}
...
<!-- DK: Change this initial sequence so that, instead of a step to build each item, we just build the plot once, and then each question switches the theme. -->
...
<!-- DK: Explain what/why this aes() is within geom_point(). -->

Within `geom_point()`, add `aes()` and, within that function, set `color` to `class`. 
...
Having learned about the built-in themes, we will now create this graphic:
...
```{r themes-12-test, include = FALSE}
...
```{r themes-13-test, include = FALSE}
...
```{r themes-14-test, include = FALSE}
...
```{r themes-15-test, include = FALSE}
...
```{r themes-16-test, include = FALSE}
...
```{r themes-17-test, include = FALSE}
...
```{r themes-18-test, include = FALSE}
...
```{r themes-19-test, include = FALSE}
...
```{r themes-20-test, include = FALSE}
...
```{r themes-21-test, include = FALSE}
...
```{r themes-22-test, include = FALSE}
...
Explore [*The Truthful Art*](https://www.amazon.com/gp/product/0321934075/) by Albert Cairo to learn more about creating effective graphics.
