...
<!-- DK: Format code (especially in tests) correctly. One statement per line. -->
...
=======
>>>>>>> 2e4ff6e68b9046b5aaea247b1f88244553ebd52f
...
<!-- DK: add a better knowledge drop -->
=======
>>>>>>> 2e4ff6e68b9046b5aaea247b1f88244553ebd52f
### Exercise 14
...
We can use the same approach to add other variables to this tibble, like the director and release date. To avoid code duplication, create an object called `section`, set its value to `https://rvest.tidyverse.org/articles/starwars.html`, then pipe this object to `read_html()`. COntinue that pipe to `html_elements()` with "section" being its argument.

```{r web-scaping-examples-45, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r web-scaping-examples-45-hint-1, eval = FALSE}
...<- "https://rvest.tidyverse.org/articles/starwars.html" |> 
         read_html() |> 
         html_elements(...)
```

```{r web-scaping-examples-45-test, include = FALSE}
...
```{r web-scaping-examples-46, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r web-scaping-examples-46-hint-1, eval = FALSE}
...
```{r web-scaping-examples-46-test, include = FALSE}
section <- "https://rvest.tidyverse.org/articles/starwars.html" |> 
         read_html() |> 
         html_elements("section")
