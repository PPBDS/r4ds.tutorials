...
<!-- sj:  errors for t.24 in discord: -->

<!-- Has anyone encountered these issues with exercises 7 and 8 in web scraping examples?
Image(web scraping exercise 7: the instructions dont work and they are different from the hint( fixed))
Andrew — 07/29/2024 6:27 PM
Web scraping: Web scraping examples: Exercise 10
There is an issue here with the Markdown.  Also in Exercise 11 
Image
Andrew — 07/29/2024 5:47 PM
Web scraping: Web scraping examples: Exercise 7
IMDb.com doesn't seem to use tables any more. Fortunately the internet archive keeps old copies of IMDb.  For example: https://web.archive.org/web/20200101054123/https://www.imdb.com/chart/top/
Melody — 07/28/2024 9:41 PM
Web scraping, section of web scraping examples exercise 7:
the instructions doesn't seem to work and is different from the hint
Image(web scraping exercise 7: the instructions dont work and they are different from the hint( fixed))
Rishi S. — 06/25/2023 2:34 PM
Typo in the web scraping basics exercise:
Image(exercise 10: htmp is spelled wrong)
...
<!-- DK: Turn the below into one or two proper questions. -->
...
<!-- DK: Examine the below and report back to me. Consult the book. -->

<!-- AC: There are issues with the current IMDb url. Tried fixing. 
View the following Discord messages: 
https://discord.com/channels/1066524559240597595/1066524726278762608/1267599310019625141
https://discord.com/channels/1066524559240597595/1066524726278762608/1267869199544619018 -->
...
<!-- DK: Do the same trick with this webpage as we did with Starwars. -->
<!-- SJ: i couldn't figure this out w/o breaking everything -->
```{r web-scaping-examples-6-test, include = FALSE}
"https://web.archive.org/web/20200101054123/https://www.imdb.com/chart/top/" |> read_html()
```
