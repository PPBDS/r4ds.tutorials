...
# DK: Probably need section created here.
...
Behind the scenes, we have just assigned the result of this pipe to an object called `section`
### Exercise 9

Type in `section` and hit run code.
