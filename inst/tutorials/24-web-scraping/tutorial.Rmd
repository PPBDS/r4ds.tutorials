...
<!-- DK: Add all missing knowledge drops. -->
...
Before we talk much about web scraping, we should talk about whether it is legal and ethical to do so. Overall, the situation is complicated. Legalities depend a lot on whre you live. However, as a general rule of thumb, is the data a public, non-personal, and factual, you're most likely ok. These three factors connect to the site’s terms and conditions, personally identifiable information, and copyright, hence their importance.
...
<!-- DK: Turn the below into one or two proper questions. First question, pipe http to read. Second, continue pipe to html_elements(). Third, we report that, behind the scenes, we have assigned the result of this pipe to an object named "section." Then, we ask the question, "Type `section` and hit Run Code. -->
