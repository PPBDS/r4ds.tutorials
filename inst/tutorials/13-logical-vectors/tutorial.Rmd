...
<!-- RM: allow_skip should be yes or no? -->
...
<!-- RM: Split into two exercises for shallower learning curve -->
...
<!-- RM: Add a new exercise to include some code missing in the tutorial -->
