...
```{r numeric-transformati-18-hint, eval = FALSE}
flights |> 
  group_by(hour = ...) |> 
...
```{r numeric-transformati-19-hint, eval = FALSE}
flights |> 
  group_by(hour = ...) |> 
  summarize(prop_cancelled = ..., n = ...) |> 
  filter(...)
...
```{r numeric-transformati-20-hint, eval = FALSE}
flights |> 
  group_by(hour = ...) |> 
  summarize(prop_cancelled = ..., n = ...) |> 
  filter(...) |> 
...
```{r numeric-transformati-21-hint, eval = FALSE}
flights |> 
  group_by(hour = ...) |> 
  summarize(prop_cancelled = ..., n = ...) |> 
  filter(...) |> 
...
```{r numeric-transformati-22-hint, eval = FALSE}
flights |> 
  group_by(hour = ...) |> 
  summarize(prop_cancelled = ..., n = ...) |> 
  filter(...) |> 
...
```{r numeric-transformati-23-hint, eval = FALSE}
flights |> 
  group_by(hour = ...) |> 
  summarize(prop_cancelled = ..., n = ...) |> 
  filter(...) |> 
...
```{r numeric-transformati-24-hint, eval = FALSE}
flights |> 
  group_by(hour = ...) |> 
  summarize(prop_cancelled = ..., n = ...) |> 
  filter(...) |> 
...
```{r numeric-transformati-25-hint, eval = FALSE}
flights |> 
  group_by(hour = ...) |> 
  summarize(prop_cancelled = ..., n = ...) |> 
  filter(...) |> 
