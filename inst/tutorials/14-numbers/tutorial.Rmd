...
<!-- This is sloppy. We are using two concepts at the same time. First, is the specific calculation using the `x7` vector. The second, in the knowledge drop, is the generic calculation which works for any vector `x`. Students find this juxtaposition confusing! -->
