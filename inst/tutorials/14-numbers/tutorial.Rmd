...
Now, let's count the number of cancelled flights or missing values of each destination. Create a new pipeline. Pipe `flights` to the `group_by()` function. Within the call to `group_by()`, put an argument of `dest`.
