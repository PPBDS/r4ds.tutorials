...
This tutorial provides practical advice for handling features like column names, types, and missing data. You will then learn about reading data from multiple files at once and writing data from R to a file. Finally, you’ll learn how to handcraft data frames in R.
...
We now return to [Chapter 8: Data import](https://r4ds.hadley.nz/data-import.html) of [*R for Data Science (2e)*](https://r4ds.hadley.nz/)
...
Write code for reading this data into R. Use `read_csv()` and set the `file` argument to "data/students.csv".
