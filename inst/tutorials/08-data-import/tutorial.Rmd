...
```{r writing-to-a-file-2-hint-2, eval = FALSE}
write_rds(iris_p, 
          "test_1.rds")
```
...
```{r data-entry-1-hint, eval = FALSE}
...
```{r data-entry-2-hint, eval = FALSE}
