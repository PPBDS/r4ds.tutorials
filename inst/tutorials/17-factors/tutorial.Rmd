...
<!-- DK: Split this into 4 separate questions.  Define csv in the setup code chunk. 1) Type Run Code for csv so that students know it exists. 2) Print csv, comment on the weird "\n" new line characters. Third. question, run read_csv on it. Third, all col_types = "c", which might be the default. 

csv
read_csv(csv)
read_csv(csv, col_types = "c")
...
<!-- DK: Split into two questions. DONE -->
