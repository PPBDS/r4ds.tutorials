...
<!-- DK: Stop using tibbles from primer.data, mainly trains. Either replace with a built in data set, like diamonds, or just delete those sections. Good tibbles to use in place of trains include diamonds, gss_cat (maybe storms), midwest, mpg. -->
