...
<!-- This tutorial is a bit of a mess. It includes lots of random junk. It does not follow the chapter too closely. But what should it do? Maybe the junk (various old plots) are good? Maybe the chapter stuff is less good? Probably best is to do both. Have a questions which cover all the material in the chapter and then, at the end of various sections, make some longer plots which require the new functions/tricks we have just learned. -->

<!-- Last student took 70 minutes, so there is room to add a graduation exercise. -->
...
```{r aesthetic-mappings-11, exercise = TRUE}

```

```{r aesthetic-mappings-11-hint-1, eval = FALSE}
diamonds |>
  select(..., ..., ...)
```
...
```{r aesthetic-mappings-12, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r aesthetic-mappings-12-hint-1, eval = FALSE}
... |>
...
```{r aesthetic-mappings-13, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r aesthetic-mappings-13-hint-1, eval = FALSE}
geom_point() is a layer so use + to add it
```

```{r aesthetic-mappings-13-hint-2, eval = FALSE}
... |>
  ggplot(mapping = aes(x = ...,
                       y = ...,
                       color = ...)) +
...
```{r aesthetic-mappings-14, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r aesthetic-mappings-14-hint-1, eval = FALSE}
... +
  geom_point(alpha = ...)
```
...
```{r aesthetic-mappings-15, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r aesthetic-mappings-15-hint-1, eval = FALSE}
... +
  geom_point(alpha = ...,
             size = ...)
```
...
```{r aesthetic-mappings-16, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r aesthetic-mappings-16-hint-1, eval = FALSE}
Remembder you are adding a layers here so use +
```

```{r aesthetic-mappings-16-hint-2, eval = FALSE}
... +
  scale_x_log10()
```
...
```{r aesthetic-mappings-17, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r aesthetic-mappings-17-hint-1, eval = FALSE}
... +
  labs(...,
       color = "Clarity",
       ...)
...
```{r geometric-objects-with-geomsmo-1, exercise = TRUE}

```

```{r geometric-objects-with-geomsmo-1-hint-1, eval = FALSE}
summary(...)
```
...
```{r geometric-objects-with-geomsmo-2}
question_text(NULL,
...
```{r geometric-objects-with-geomsmo-3, exercise = TRUE}

```

```{r geometric-objects-with-geomsmo-3-hint-1, eval = FALSE}
ggplot(data = ...)
```
...
```{r geometric-objects-with-geomsmo-4, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r geometric-objects-with-geomsmo-4-hint-1, eval = FALSE}
...
```{r geometric-objects-with-geomsmo-5, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r geometric-objects-with-geomsmo-5-hint-1, eval = FALSE}
ggplot(data = polling_data,
       mapping = aes(x = createddate,
                     y = rate,
                     color = ...))
...
```{r geometric-objects-with-geomsmo-6, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r geometric-objects-with-geomsmo-6-hint-1, eval = FALSE}
ggplot(data = polling_data,
       mapping = aes(x = createddate,
                     y = rate,
                     color = approval_type)) +
...
```{r geometric-objects-with-geomsmo-7, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r geometric-objects-with-geomsmo-7-hint-1, eval = FALSE}
ggplot(data = ...,
       mapping = aes(x = ...,
                     y = ...,
                     color = ...)) +
...
```{r geometric-objects-with-geomsmo-8, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r geometric-objects-with-geomsmo-8-hint-1, eval = FALSE}
... + 
  ...()
```
...
```{r geometric-objects-with-geomsmo-9, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r geometric-objects-with-geomsmo-9-hint-1, eval = FALSE}
... + 
  geom_smooth(method = ...)
```
...
```{r geometric-objects-with-geomsmo-10, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r geometric-objects-with-geomsmo-10-hint-1, eval = FALSE}
... + 
  geom_smooth(method = "gam",
              formula = ...)
```
...
```{r geometric-objects-with-geomsmo-11, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r geometric-objects-with-geomsmo-11-hint-1, eval = FALSE}
... + 
  geom_smooth(method = "gam",
              formula = y ~ s(x, bs = "cs"),
              se = ...)
...
```{r geometric-objects-with-geomsmo-12, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r geometric-objects-with-geomsmo-12-hint-1, eval = FALSE}
...+
...
```{r geometric-objects-with-geomsmo-13, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r geometric-objects-with-geomsmo-13-hint-1, eval = FALSE}
+ 
  theme(...="bottom")
```
...
```{r geometric-objects-with-geomsmo-14, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r geometric-objects-with-geomsmo-14-hint-1, eval = FALSE}
... +
  labs(x = ...,
       y = ...,
       title = ...,
...
```{r geometric-objects-with-geomhis-1, exercise = TRUE}
...
```{r geometric-objects-with-geomhis-2, exercise = TRUE}

```

```{r geometric-objects-with-geomhis-2-hint-1, eval = FALSE}
glimpse(...)
```
...
```{r geometric-objects-with-geomhis-3, exercise = TRUE}

```

```{r geometric-objects-with-geomhis-3-hint-1, eval = FALSE}
mpg$...
```
...
```{r geometric-objects-with-geomhis-4, exercise = TRUE}

```

```{r geometric-objects-with-geomhis-4-hint-1, eval = FALSE}
...  |> 
  mutate(... = as.character(...))
```
...
```{r geometric-objects-with-geomhis-5, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r geometric-objects-with-geomhis-5-hint-1, eval = FALSE}
...  |> 
  select(..., ...)
```
...
```{r geometric-objects-with-geomhis-6, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r geometric-objects-with-geomhis-6-hint-1, eval = FALSE}
... |> 
  ggplot(aes(x = ..., fill = ...))
```
...
```{r geometric-objects-with-geomhis-7, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r geometric-objects-with-geomhis-7-hint-1, eval = FALSE}
geom_histogram() is a layer so use + to add it
```

```{r geometric-objects-with-geomhis-7-hint-2, eval = FALSE}
...|> 
  ... +
  ...()
```
...
```{r geometric-objects-with-geomhis-8, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r geometric-objects-with-geomhis-8-hint-1, eval = FALSE}
... +
  geom_histogram(bins = ...)
```
...
```{r geometric-objects-with-geomhis-9, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r geometric-objects-with-geomhis-9-hint-1, eval = FALSE}
... +
  geom_histogram(bins = 6, 
                 color = ...)
```
...
```{r geometric-objects-with-geomhis-10, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r geometric-objects-with-geomhis-10-hint-1, eval = FALSE}
... +
  labs(..., 
       fill = "Year",
       ...)
...
```{r geometric-objects-with-geomhis-11, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r geometric-objects-with-geomhis-11-hint-1, eval = FALSE}
... +
  ...()
```
...
```{r facets-and-statistical-transfo-1, exercise = TRUE}

```

```{r facets-and-statistical-transfo-1-hint-1, eval = FALSE}
mpg |> 
  select(..., ..., ...)
```
...
```{r facets-and-statistical-transfo-2, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r facets-and-statistical-transfo-2-hint-1, eval = FALSE}
... |> 
  summarize(total = ...)
```

```{r facets-and-statistical-transfo-2-hint-2, eval = FALSE}
... |> 
  summarize(total = n())
```
...
```{r facets-and-statistical-transfo-3, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r facets-and-statistical-transfo-3-hint-1, eval = FALSE}
... |> 
  summarize(total = n(),
            .by = c(..., ..., ...))  
```
...
```{r facets-and-statistical-transfo-4, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r facets-and-statistical-transfo-4-hint-1, eval = FALSE}
ggplot(aes(x = ..., 
           y = ...) +
  ...()
```
...
```{r facets-and-statistical-transfo-5, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r facets-and-statistical-transfo-5-hint-1, eval = FALSE}
ggplot(data = ... , 
          aes(x = ..., 
              y = ...,
              fill = ...) +
...
```{r facets-and-statistical-transfo-6, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r facets-and-statistical-transfo-6-hint-1, eval = FALSE}
... + 
  facet_wrap(~ ...)
```
...
```{r facets-and-statistical-transfo-7, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r facets-and-statistical-transfo-7-hint-1, eval = FALSE}
facet_wrap(~ drv,
           ... = as_labeller(...)) +
```
...
```{r facets-and-statistical-transfo-8, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r facets-and-statistical-transfo-8-hint-1, eval = FALSE}
... +
  labs(..., 
       fill = "...",
       ...)
...
```{r statistical-transformations-an-1, exercise = TRUE}

```

```{r statistical-transformations-an-1-hint-1, eval = FALSE}
...(midwest)
```
...
```{r statistical-transformations-an-2, exercise = TRUE}

```

```{r statistical-transformations-an-2-hint-1, eval = FALSE}
ggplot(data = ..., 
       mapping = aes(x =..., 
                     fill =...))
```
...
```{r statistical-transformations-an-3, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r statistical-transformations-an-3-hint-1, eval = FALSE}
... +
  geom_bar()
```
...
```{r statistical-transformations-an-4, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r statistical-transformations-an-4-hint-1, eval = FALSE}
... + geom_bar(alpha = ..., 
               position = ...)
```
...
```{r statistical-transformations-an-5, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r statistical-transformations-an-5-hint-1, eval = FALSE}
... +
  labs(..., 
       fill = "...",
       ...)
