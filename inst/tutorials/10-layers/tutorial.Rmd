...
```{r aesthetic-mappings-simple-geom-1, exercise = TRUE}

```

```{r aesthetic-mappings-simple-geom-1-hint-1, eval = FALSE}
glimpse(...)
```
...
```{r aesthetic-mappings-simple-geom-2, exercise = TRUE}

```

```{r aesthetic-mappings-simple-geom-2-hint-1, eval = FALSE}
library(...)
```
...
```{r aesthetic-mappings-simple-geom-3, exercise = TRUE}

```

```{r aesthetic-mappings-simple-geom-3-hint-1, eval = FALSE}
ggplot(...)
```
...
```{r aesthetic-mappings-simple-geom-4, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r aesthetic-mappings-simple-geom-4-hint-1, eval = FALSE}
ggplot(mpg, aes(x = ..., 
                ... = hwy))
```
...
```{r aesthetic-mappings-simple-geom-5, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r aesthetic-mappings-simple-geom-5-hint-1, eval = FALSE}
...
```{r aesthetic-mappings-simple-geom-6, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r aesthetic-mappings-simple-geom-6-hint-1, eval = FALSE}
ggplot(mpg, aes(x = ..., 
                y = ..., 
                color = ...)) +
  geom_point()
...
```{r aesthetic-mappings-advanced-ge-1, exercise = TRUE}

```

```{r aesthetic-mappings-advanced-ge-1-hint-1, eval = FALSE}
?diamonds
```
...
```{r aesthetic-mappings-advanced-ge-2}
  question_text(NULL,
...
```{r aesthetic-mappings-advanced-ge-3, exercise = TRUE}

```

```{r aesthetic-mappings-advanced-ge-3-hint-1, eval = FALSE}
diamonds |>
  select(..., ..., ...)
```
...
```{r aesthetic-mappings-advanced-ge-4, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r aesthetic-mappings-advanced-ge-4-hint-1, eval = FALSE}
... |>
...
```{r aesthetic-mappings-advanced-ge-5, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r aesthetic-mappings-advanced-ge-5-hint-1, eval = FALSE}
geom_point() is a layer so use + to add it
```

```{r aesthetic-mappings-advanced-ge-5-hint-2, eval = FALSE}
... |>
  ggplot(mapping = aes(x = ...,
                       y = ...,
                       color = ...)) +
...
```{r aesthetic-mappings-advanced-ge-6, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r aesthetic-mappings-advanced-ge-6-hint-1, eval = FALSE}
... +
  geom_point(alpha = ...)
```
...
```{r aesthetic-mappings-advanced-ge-7, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r aesthetic-mappings-advanced-ge-7-hint-1, eval = FALSE}
... +
  geom_point(alpha = ...,
             size = ...)
```
...
```{r aesthetic-mappings-advanced-ge-8, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r aesthetic-mappings-advanced-ge-8-hint-1, eval = FALSE}
Remembder you are adding a layers here so use +
```

```{r aesthetic-mappings-advanced-ge-8-hint-2, eval = FALSE}
... +
  scale_x_log10()
```
...
```{r aesthetic-mappings-advanced-ge-9, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r aesthetic-mappings-advanced-ge-9-hint-1, eval = FALSE}
... +
  labs(...,
       color = "Clarity",
       ...)
