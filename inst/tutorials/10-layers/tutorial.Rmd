...
```{r statistical-transformations-1-hint, eval = FALSE}
...
```{r statistical-transformations-2-hint, eval = FALSE}
...
```{r statistical-transformations-3-hint, eval = FALSE}
...
```{r statistical-transformations-4-hint, eval = FALSE}
...
```{r statistical-transformations-5-hint, eval = FALSE}
