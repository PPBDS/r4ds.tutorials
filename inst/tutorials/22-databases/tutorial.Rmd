...
con <- DBI::dbConnect(duckdb::duckdb(), dbdir = "newdb")
mpg_sql <- "
...
Copy the code from above. Now within the `con` variable, add `dbdir` and set it to "newdb".
