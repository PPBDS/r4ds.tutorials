...
<!-- Add an exercise which downloads a file from the web, and then moves it to a new directory. This is good practice for the class session doing the same. -->
...
Move into the `class` directory by running `cd class`. Run `pwd`. CP/CR.
...
<!-- DK: Last topic to review closely. Seems wordy. -->
