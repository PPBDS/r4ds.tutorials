...
Run `year()`, `month()`, `mday()`, `yday()`, `wday()`, `hour()`, `minute()` and `second()` on `datetime`

```{r datetime-components-with-getti-1-ex, exercise = TRUE}
datetime <- ymd_hms("2026-07-08 12:34:56")
```

```{r datetime-components-with-getti-1-hint, eval = FALSE}
year(...)
month(...)
mday(...)
yday(...)
...
```{r datetime-components-with-getti-2-ex, exercise = TRUE}
datetime <- ymd_hms("2026-07-08 12:34:56")
```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r datetime-components-with-getti-2-hint, eval = FALSE}
month(..., label = ...)
```
...
```{r datetime-components-with-getti-3-ex, exercise = TRUE}
datetime <- ymd_hms("2026-07-08 12:34:56")
```

```{r datetime-components-with-getti-3-hint, eval = FALSE}
wday(..., label = ..., abbr = ...)
```
...
For `month()` and `wday()` you can set `label = TRUE` to return the abbreviated name of the month or day of the week. You can set `abbr = FALSE` to return the full name.
...
```{r datetime-components-with-getti-4-ex, exercise = TRUE}

```

```{r datetime-components-with-getti-4-hint, eval = FALSE}
flights_dt |>
  mutate(weekday = wday(..., ....))
```
...
```{r datetime-components-with-getti-5-ex, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r datetime-components-with-getti-5-hint, eval = FALSE}
... |>
  ggplot(aes(x = ...))
```
...
```{r datetime-components-with-getti-6-ex, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r datetime-components-with-getti-6-hint, eval = FALSE}
...+
  geom_bar()
```
