...
<!-- Do the tutorial and send me your answers. -->
<!-- Read the Chapter: https://r4ds.hadley.nz/numbers -->
<!-- Add test code chunks to each question. Or fix test chunk lables, with "-test,", in any test code chunk without them.  -->
<!-- Skip lines between tests and code chunks. -->
