...
<!-- Do the tutorial and send me your answers. Done --> 
<!-- Read the Chapter: https://r4ds.hadley.nz/numbers Done --> 
<!-- Add test code chunks to each question. Or fix test chunk lables, with "-test,", in any test code chunk without them. Done -->
<!-- Skip lines between tests and code chunks. Done-->
<!-- Edit Knowledge drops as needed. -->
<!-- Go on to tutorials 14 and 15. -->
...
```{r numeric-transformations-7, include = FALSE}
df |> 
  mutate(
