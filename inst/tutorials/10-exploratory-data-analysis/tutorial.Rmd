...
<!-- Thanks to Srihith Garlapati and Heather Li -->
...
```{r the-us-life-expectancy-gap-2}
  question_text(NULL,
...
```{r the-us-life-expectancy-gap-3, exercise = TRUE}

```

```{r the-us-life-expectancy-gap-3-hint-1, eval = FALSE}
oecd_sum |> 
  select(-other, -usa)
```
...
```{r the-us-life-expectancy-gap-10}
question_text(NULL,
...
```{r the-us-life-expectancy-gap-12, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r the-us-life-expectancy-gap-12-hint-1, eval = FALSE}
... +
  theme(plot.title = element_text(face ="bold")
```
...
```{r the-us-life-expectancy-gap-20, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r the-us-life-expectancy-gap-20-hint-1, eval = FALSE}
...,
plot.caption = element_text(face = "italic")
```
...
```{r the-us-life-expectancy-gap-21, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r the-us-life-expectancy-gap-21-hint-1, eval = FALSE}
...,
plot.caption = element_text(face = "italic",
                            margin = margin(t = 5))
```
...
```{r the-us-life-expectancy-gap-22, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r the-us-life-expectancy-gap-22-hint-1, eval = FALSE}
axis.title.y = element_text(face = "bold")
```
...
```{r the-us-life-expectancy-gap-23, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r the-us-life-expectancy-gap-23-hint-1, eval = FALSE}
axis.text = element_text(face = "bold"))
```
