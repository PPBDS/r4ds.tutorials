...
The x-axis is a bit too thick and bold. We can reduce the width of the line. Within `element_line()` set the argument `linewidth` equal to 0.2. 
...
Good! You can modify the width of lines just as you can modify the size of points in `geom_point()`.
