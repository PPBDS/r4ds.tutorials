...
```{r replacing-a-scale-1-hint, eval = FALSE}
...
```{r replacing-a-scale-2-hint, eval = FALSE}
diamonds |> 
  ggplot(aes(x = ..., y = ...))
```
...
```{r replacing-a-scale-3-hint, eval = FALSE}
... +
  geom_bin2d()
```
...
```{r replacing-a-scale-4-hint, eval = FALSE}
diamonds |> 
...
```{r replacing-a-scale-5-hint, eval = FALSE}
diamonds |> 
  ggplot(aes(x = ..., y = ...)) +
  geom_bin2d() +
  scale_x_log10()
...
```{r replacing-a-scale-6-hint, eval = FALSE}
... + 
  scale_y_log10()
```
...
```{r replacing-a-scale-7-hint, eval = FALSE}
mpg |> 
  ggplot(aes(x = ..., y = ...))
```
...
```{r replacing-a-scale-8-hint, eval = FALSE}
,,, +
  geom_point(aes(color = ...))
```
...
```{r replacing-a-scale-9-hint, eval = FALSE}
... +
...
```{r replacing-a-scale-10-hint, eval = FALSE}
... +
...
```{r replacing-a-scale-11-hint, eval = FALSE}
presidential |> 
  mutate(id = ...)
```
...
```{r replacing-a-scale-12-hint, eval = FALSE}
... + 
  ggplot(aes(x = ..., y = ..., color = ...))
```
...
```{r replacing-a-scale-13-hint, eval = FALSE}
... +
  geom_point()
```
...
```{r replacing-a-scale-14-hint, eval = FALSE}
... +
  geom_segment(aes(xend = ..., yend = ...))
```
...
```{r replacing-a-scale-15-hint, eval = FALSE}
... +
...
```{r replacing-a-scale-16-hint, eval = FALSE}
random_vals
```
...
```{r replacing-a-scale-17-hint, eval = FALSE}
random_vals |> 
  ggplot(aes(x, y))
```
...
```{r replacing-a-scale-18-hint, eval = FALSE}
... +
  geom_hex()
```
...
```{r replacing-a-scale-19-hint, eval = FALSE}
... +
  coord_fixed()
```
...
```{r replacing-a-scale-20-hint, eval = FALSE}
... +
...
```{r replacing-a-scale-21-hint, eval = FALSE}
... +
...
```{r replacing-a-scale-22-hint, eval = FALSE}
