...
```{r covariation-1-hint, eval = FALSE}
diamonds |> 
  ...
```
...
```{r covariation-2-hint, eval = FALSE}
diamonds |> 
  ggplot(aes(x = ...))
```
...
```{r covariation-3-hint, eval = FALSE}
... + 
  geom_freqpoly()
```
...
```{r covariation-4-hint, eval = FALSE}
... + 
  geom_freqpoly(aes(color = ...))
```
...
```{r covariation-5-hint, eval = FALSE}
... + 
...
```{r covariation-6-hint, eval = FALSE}
... + 
...
```{r covariation-7-hint, eval = FALSE}
diamonds |> 
...
```{r covariation-8-hint, eval = FALSE}
... + 
  labs(
    title = ...,
    subtitle = ...,
...
```{r covariation-9-hint, eval = FALSE}
diamonds |> 
  ggplot()
```
...
```{r covariation-10-hint, eval = FALSE}
diamonds |> 
  ggplot(aes(x = ...))
```
...
```{r covariation-11-hint, eval = FALSE}
diamonds |> 
  ggplot(aes(x = cut, y = ...))
```
...
```{r covariation-12-hint, eval = FALSE}
... +
  geom_boxplot()
```
...
```{r covariation-13-hint, eval = FALSE}
... + 
  labs(
    title = ...,
    subtitle = ...,
...
```{r covariation-14-hint, eval = FALSE}
mpg
```
...
```{r covariation-15-hint, eval = FALSE}
mpg |> 
  ggplot()
```
...
```{r covariation-16-hint, eval = FALSE}
mpg |> 
  ggplot(aes(x = ...))
```
...
```{r covariation-17-hint, eval = FALSE}
mpg |> 
...
```{r covariation-18-hint, eval = FALSE}
... + 
  geom_boxplot()
```
...
```{r covariation-19-hint, eval = FALSE}
...
```{r covariation-20-hint, eval = FALSE}
mpg |> 
  ggplot(aes(x = ..., y = ...)) + 
  ...
```
...
```{r covariation-21-hint, eval = FALSE}
... + 
  labs(
    title = ...,
    subtitle = ...,
