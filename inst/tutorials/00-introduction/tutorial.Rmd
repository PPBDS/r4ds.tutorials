...
<!-- DK: Change intro section to go through diamonds with each single command and then midwest with each command. (Don't have to do all of them again. Example, no need to do print() and then print(x, n = 3) twice. Your discretion.) Split up the knowledge drops. DONE -->
...
<!-- DK: What will they learn? Revisit: https://ppbds.github.io/tutorial.helpers/articles/books.html DONE-->
...
You will learn how to work with data sets from the [ggplot2](https://ggplot2.tidyverse.org) using the pipe command and make some cool plots to visualize the data. Then, you will learn how to create an Rscript file to store your code.
...
```{r what-you-will-learn-20-test, include = FALSE}
glimpse(midwest)
```
...
On top of your RStudio window, click on "File" and then "New File." Choose "R Script." Copy/paste the code from the plot into the script. Save the script as `analysis.R`. 
...
This tutorial covers the [Introduction](https://r4ds.hadley.nz/intro.html) from [*R for Data Science (2e)*](https://r4ds.hadley.nz/) by Hadley Wickham, Mine Çetinkaya-Rundel, and Garrett Grolemund. You have learned how to work with data sets from the [ggplot2](https://ggplot2.tidyverse.org) using the pipe command and make some cool plots to visualize the data. You also learned how to create an Rscript file to store your code.
