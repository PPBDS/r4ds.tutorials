...
<!-- DK: Change intro section to go through diamonds with each single command and then midwest with each command. (Don't have to do all of them again. Example, no need to do print() and then print(x, n = 3) twice. Your discretion.) Split up the knowledge drops. -->
