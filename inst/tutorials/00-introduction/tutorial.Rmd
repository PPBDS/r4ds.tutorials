...
<!-- Need to make sure the early tutorials cover things like scale_x_log10(labels = scales::comma_format()) since we use it in class in weeks 1 and 2. Other stuff we use in those classes, string manipulation for county, state -> state? -->
