...
You will learn how to explore new data sets. 

<!-- DK: data sets, summmary, glimpse -->
...
<!-- DK: All commands on diamonds and then all commands on midwest. -->
...
<!-- Split into two questions. First, list.files(pattern = "analysis") first. Tell them not to worry if this fails. Mention that directory locations are tricky. Second, tell them to run the script, then ask the below question. -->
