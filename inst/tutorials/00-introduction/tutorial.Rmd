...
```{r what-you-will-learn-ex-4, exercise = TRUE}
...
```{r what-you-will-learn-ex-5, exercise = TRUE}
...
```{r what-you-will-learn-ex-6, exercise = TRUE}
...
```{r what-you-will-learn-ex-7, exercise = TRUE}
...
This produces the same result as just typing `diamonds`. But `print()` is more flexible, allowing us to specify different numbers of rows and columns. You can use the `width` argument to change how many columns appear. `print(diamonds, n = Inf, width = Inf)` will cause everything to be printed.

### Exercise 8

Print out the first three rows of `diamonds`. Note that the number of rows printed is controlled by the `n` argument.

```{r what-you-will-learn-ex-8, exercise = TRUE}
...
```{r what-you-will-learn-ex-9, exercise = TRUE}
...
```{r what-you-will-learn-ex-10, exercise = TRUE}
...
```{r what-you-will-learn-ex-11, exercise = TRUE}
sqrt(144)
```
...
```{r how-this-book-is-organized-ex-1, exercise = TRUE}
...
```{r how-this-book-is-organized-ex-2, exercise = TRUE}
...
```{r how-this-book-is-organized-ex-3, exercise = TRUE}
...
```{r how-this-book-is-organized-ex-4, exercise = TRUE}
...
```{r how-this-book-is-organized-ex-5, exercise = TRUE}
...
```{r how-this-book-is-organized-ex-6, exercise = TRUE}
...
```{r how-this-book-is-organized-ex-7, exercise = TRUE}
...
The caption is generally used to credit a the relevant data sources.

```{r how-this-book-is-organized-ex-8, exercise = TRUE }
...
install.packages(
  c("arrow", "babynames", "curl", "duckdb", "gapminder", 
    ...
    "maps", "nycflights13", "openxlsx", "palmerpenguins", 
...
```{r running-r-code-ex-1, exercise = TRUE}
...
Recall that the `+` sign is used to "chain" different pieces of plot creation code together. When doing data analysis, we use the "pipe" symbol --- `|>` --- to do the same things between different pieces code which manipulate the data.
...
```{r running-r-code-6-hint, eval = FALSE}
... |> 
  arrange(desc(...))
```
