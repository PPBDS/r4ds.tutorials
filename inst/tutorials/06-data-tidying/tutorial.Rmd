...
```{r lengthening-data-10-hint, eval = FALSE}
billboard_longer |>
```
...
Continue your pipe wiht `ggplot()`.
...
```{r lengthening-data-11-hint, eval = FALSE}
billboard_longer |>
  ggplot()
```
...
```{r lengthening-data-12-hint, eval = FALSE}
...
```{r lengthening-data-13-hint, eval = FALSE}
...
```{r lengthening-data-14-hint, eval = FALSE}
geom_line(...) +
  scale_y_reverse()
```
...
```{r lengthening-data-15-hint, eval = FALSE}
