...
<!-- There is an "annoying" bug discussed below. Should provide a reprex of this to RStudio folks. -->
...
In this tutorial, we will work with Quarto directly from the Terminal. This is "Quarto CLI", where the initials stand for **C**ommand **L**ine **I**nterface. We make this choice in order to get you more comfortable with the command line, a useful skill in your data science journey. 

<!-- DK: It is somewhat tempting to create three websites, one from CLI, one from the **quarto** package and one from RStudio point-and-click. That would be educational! But also time consuming and annoying . . . -->
