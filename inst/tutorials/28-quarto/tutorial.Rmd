...
description: 'Tutorial for Chapter 28: Quarto and Chapter 29: Quarto formats, with a focus on Quarto websites.'
---
...
<!-- I have installed version 1.4 of Quarto. But that is not currently the version bundled with RStudio. Keep an eye on this. Also keep track of the CRAN version of quarto, which does not (yet) include create_quarto_project(). -->
