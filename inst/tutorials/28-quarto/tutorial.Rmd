...
The preview command does two things. First, it renders the `qmd` files, just like `render` does. Second, it sets up a viewer --- probably the "Viewer" tab in the Files pane, but possibly your default web browser --- so that you can see what the website looks like.. Click around and check it out!
