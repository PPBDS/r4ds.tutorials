...
```{r apply-family-4-hint, eval = FALSE}
num_cols <- ...(df4, ...)
```
...
```{r apply-family-8-hint, eval = FALSE}
tapply(..$.., ..$.., ...)
...
```{r for-loops-10-hint, eval = FALSE}
for(i in ...) {
  save_data[[...]] <- ...[[i]]
}
```
...
```{r for-loops-11-hint, eval = FALSE}
save_data
