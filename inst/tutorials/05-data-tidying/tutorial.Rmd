...
```{r tidy-data-ex-4, exercise = TRUE}
table1
table2
table3
```
...
```{r tidy-data-ex-5, exercise = TRUE}
...
```{r tidy-data-ex-8, exercise = TRUE}
...
```{r tidy-data-ex-10, exercise = TRUE}
...
```{r tidy-data-ex-12, exercise = TRUE}
...
```{r tidy-data-ex-13, exercise = TRUE}
...
```{r tidy-data-ex-14, exercise = TRUE}
...
```{r tidy-data-ex-15, exercise = TRUE}
...
```{r tidy-data-ex-16, exercise = TRUE}
...
```{r tidy-data-ex-17, exercise = TRUE}
...
```{r tidy-data-ex-18, exercise = TRUE}
...
```{r tidy-data-ex-19, exercise = TRUE}
...
```{r lengthening-data-ex-1, exercise = TRUE}
...
```{r lengthening-data-ex-2, exercise = TRUE}
...
```{r lengthening-data-ex-3, exercise = TRUE}
...
```{r lengthening-data-ex-4, exercise = TRUE}
...
```{r lengthening-data-ex-5, exercise = TRUE}
...
```{r lengthening-data-ex-6, exercise = TRUE}
...
```{r lengthening-data-ex-7, exercise = TRUE}
...
```{r lengthening-data-ex-8, exercise = TRUE}
...
```{r lengthening-data-ex-9, exercise = TRUE}
...
```{r lengthening-data-ex-10, exercise = TRUE}
...
```{r widening-data-ex-3, exercise = TRUE}
...
```{r widening-data-ex-4, exercise = TRUE}
...
```{r widening-data-ex-5, exercise = TRUE}
...
```{r widening-data-ex-6, exercise = TRUE}
...
```{r babynames-ex-1, exercise = TRUE}
...
```{r babynames-ex-3, exercise = TRUE}
...
```{r babynames-ex-4, exercise = TRUE}
...
```{r babynames-ex-5, exercise = TRUE}
...
```{r babynames-ex-6, exercise = TRUE}
...
```{r babynames-ex-7, exercise = TRUE}
...
```{r babynames-ex-8, exercise = TRUE}
...
```{r babynames-ex-9, exercise = TRUE}
...
```{r babynames-ex-10, exercise = TRUE}
...
```{r babynames-ex-11, exercise = TRUE}
