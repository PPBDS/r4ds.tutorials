...
<!-- Make sure your section names are not duplicative! If they are, Format Tutorial Chunk Labels will (?) not work. Things only work now because we use geom_bar as a section title above, and then `geom_bar()` as the section title below. This should be rationalized! -->
