...
>>>>>>> a4ea927d5fb9f9cb354bb38b8611ed856336b2f7
  labs( ... = "Body mass and flipper length",
        subtitle = "...")
```
...
<<<<<<< HEAD
Remove the `color` aesthetic within `ggplot()` and add it to `geom_point` by running `geom_point(mapping = aes(color = species))` to get a single line for the plot instead of three.
=======
