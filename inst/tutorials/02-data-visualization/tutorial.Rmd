...
To integrate another categorical variable, set `fill` to `species` within `aes()`.
...
Let's find the percentages of each penguins species on each island, so run `position = "fills"` within `geom_bar()`.
