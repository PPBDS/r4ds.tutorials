...
Before creating our first plot, we should learn a little more about the data set we will be using, so go to help page of the `palmerpenguins` by typing `?palmerpenguins`. After doing so, copy and paste the description here.
