...
```{r basic-joins-1-hint, eval = FALSE}
flights2 <- ... |> 
 ...(year, ..., origin, dest, ....,...)
flights2
```
...
```{r basic-joins-2-hint, eval = FALSE}
... |>
  left_join(...)
```
...
```{r basic-joins-3-hint, eval = FALSE}
... |> 
...
```{r basic-joins-4-hint, eval = FALSE}
... |> 
  ...(...)
```
...
```{r basic-joins-5-hint, eval = FALSE}
...
```{r basic-joins-6-hint, eval = FALSE}
...
```{r basic-joins-7-hint, eval = FALSE}
... |> 
  ...(planes, join_by(...))
```
...
```{r basic-joins-8-hint, eval = FALSE}
... |> 
  ...(airports, join_by(...))
```
...
```{r basic-joins-9-hint, eval = FALSE}
...
```{r basic-joins-10-hint, eval = FALSE}
...
```{r basic-joins-11-hint, eval = FALSE}
...
```{r basic-joins-12-hint, eval = FALSE}
...
```{r basic-joins-13-hint, eval = FALSE}
